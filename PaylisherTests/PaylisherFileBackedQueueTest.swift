//
//  PaylisherFileBackedQueueTest.swift
//  PaylisherTests
//
...
class PaylisherFileBackedQueueTest: QuickSpec {
    let eventJson =
        """
        {
          "properties": {
            ...
            "$device_name": "iPhone",
            "$app_name": "",
            "$app_namespace": "com.paylisher.CocoapodsExample",
            "$locale": "en-US",
    ...
    func getSut() -> PaylisherFileBackedQueue {
        ...
        return PaylisherFileBackedQueue(queue: newURL, oldQueue: oldURL)
    }
