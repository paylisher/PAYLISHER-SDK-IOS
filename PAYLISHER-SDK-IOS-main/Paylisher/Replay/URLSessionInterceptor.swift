 ...
 */
    ...
    class URLSessionInterceptor {
        ...
        private let queue = DispatchQueue(label: "com.paylisher.URLSessionInterceptor", target: .global(qos: .utility))
        ...
        private func isCaptureNetworkEnabled() -> Bool {
            config.sessionReplayConfig.captureNetworkTelemetry && PaylisherSDK.shared.isSessionReplayActive()
        }
