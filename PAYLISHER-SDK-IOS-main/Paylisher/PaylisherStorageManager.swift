...
// Internal class to manage the storage metadata of the Paylisher SDK
public class PaylisherStorageManager {
    ...
    init(_ config: PaylisherConfig) {
        storage = PaylisherStorage(config)
