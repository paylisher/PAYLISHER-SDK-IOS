...
// MARK: - Custom Method to Handle Notification Logic

/// This method performs all the “customization” work on the notification.
/// It uses a completion handler because image attachment (and possibly other tasks)
/// may be asynchronous.
