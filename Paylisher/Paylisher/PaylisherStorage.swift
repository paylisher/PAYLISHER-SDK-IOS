...
/**
 ...
 paylisher-ios stores data either to file or to UserDefaults in order to support tvOS. As recordings won't work on tvOS anyways and we have no tvOS users so far,
...
class PaylisherStorage {
    ...
    enum StorageKey: String {
        case distinctId = "paylisher.distinctId"
        case anonymousId = "paylisher.anonymousId"
        case queue = "paylisher.queueFolder" // NOTE: This is different to paylisher-ios v2
        case oldQeueue = "paylisher.queue.plist"
        case replayQeueue = "paylisher.replayFolder"
        case enabledFeatureFlags = "paylisher.enabledFeatureFlags"
        case enabledFeatureFlagPayloads = "paylisher.enabledFeatureFlagPayloads"
        case groups = "paylisher.groups"
        case registerProperties = "paylisher.registerProperties"
        case optOut = "paylisher.optOut"
    ...
    /**
     There are cases where applications using paylisher-ios want to share analytics data between host app and
     ...
     */
    private static func getAppFolderUrl(from configuration: PaylisherConfig) -> URL {
        /**
