...
public class PaylisherEvent {
    ...
    static func fromJSON(_ data: Data) -> PaylisherEvent? {
    ...
    static func fromJSON(_ json: [String: Any]) -> PaylisherEvent? {
